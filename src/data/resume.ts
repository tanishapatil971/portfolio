export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/tanishapatil971",
        icon: "github",
      },
      LinkedIn: {
        name: "LinkedIn",
      ...
      LeetCode: {
        name: "LeetCode",
        url: "https://leetcode.com/u/patilTanisha/",
        icon: "code",
      },
    },
  },
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "A machine learning based recommendation engine that suggests movies based on user preferences and viewing history.",
